# Hermes 7-Day Watchdog AMBER — 2026-05-01T03:47:33+08:00
...
- checkpoint_age: 33.1 minutes before this report was written.
- run_state: status=running, last_updated=2026-04-30T12:07:15+08:00; logical age is INFO only per Patch #18 because current reports/checkpoints are fresh and the latest daily executor is GREEN.
...
- INFO: WSL `curl http://127.0.0.1:11434/v1/models` failed with rc=7 / HTTP 000, but Windows-side PowerShell verification is UP; classified as WSL2 localhost isolation, not model outage.
...
- 2026-05-01T03:14:24.398060+08:00 age=33.1m size=4436: `WATCHDOG_AMBER_2026-05-01_0313.md`
- 2026-05-01T02:40:45.932742+08:00 age=66.8m size=4711: `WATCHDOG_AMBER_2026-05-01_0240.md`
- 2026-05-01T02:05:59.361064+08:00 age=101.6m size=3794: `WATCHDOG_RED_2026-05-01_0205.md`
- 2026-05-01T01:32:34.968337+08:00 age=135.0m size=3532: `WATCHDOG_RED_2026-05-01_0132.md`
- 2026-05-01T00:57:42.291414+08:00 age=169.9m size=4656: `WATCHDOG_AMBER_2026-05-01_0056.md`
...
- `805 397 Sl openclaw-gateway openclaw-gateway`
...
## Mini review
US-002 已完成；本轮 disk/llama/checkpoint 正常，当前仅剩 OpenClaw 常驻进程 AMBER，未见活跃 live-root recursive scan；US-003 仍应在 WeChat GREEN 前只做 status/context-gate/queue 分析并保留 live-root scan gate。
