# Hermes 7-Day Watchdog AMBER — 2026-05-01T07:20:34+08:00
...
- checkpoint_age: 33.9 minutes by latest reports entry before this report write (`WATCHDOG_AMBER_2026-05-01_0645.md`).
...
- Recent recurrence risk increased/continues: 4 RED watchdog reports in the last 6h contained live-root recursive scan evidence (`WATCHDOG_RED_2026-05-01_0611.md`, `WATCHDOG_RED_2026-05-01_0531.md`, `WATCHDOG_RED_2026-05-01_0205.md`, `WATCHDOG_RED_2026-05-01_0132.md`).
...
- 2026-05-01T06:46:37+08:00 age=33.9m: `WATCHDOG_AMBER_2026-05-01_0645.md`
- 2026-05-01T06:11:53+08:00 age=68.7m: `WATCHDOG_RED_2026-05-01_0611.md`
- 2026-05-01T05:33:10+08:00 age=107.4m: `WATCHDOG_RED_2026-05-01_0531.md`
- 2026-05-01T04:59:38+08:00 age=140.9m: `WATCHDOG_AMBER_2026-05-01_0456.md`
- 2026-05-01T04:24:52+08:00 age=175.7m: `WATCHDOG_AMBER_2026-05-01_0423.md`
...
- OpenClaw WSL processes observed:
  ...
  - `pc         23989 56.0  8.5 19698472 1397344 ?    Rl   06:27  29:42 openclaw-gateway`
...
- Current escalation: no active live-root scan now, but recurrence risk remains because 4 recent RED watchdogs captured the scan.
...
## Mini review
US-002 已完成/GREEN；当前无活动 live-root 扫描阻塞，但 OpenClaw/helper 仍驻留且 6h 内已有 4 次同类 RED，US-003 前继续执行 live-root gate，并在 WeChat RED 时跳过 capture。
...
```json
{
  ...
  "amber": [
    ...
    "recurring recent live-root scan RED reports in last 6h: 4"
  ],
  "info": [
    "WSL curl localhost rc=7 treated as WSL2 localhost isolation because Windows PowerShell HTTP 200 confirms llama-swap UP",
    "run-state logical timestamp stale 1153.3m; de-noised because latest reports/daily evidence exist",
