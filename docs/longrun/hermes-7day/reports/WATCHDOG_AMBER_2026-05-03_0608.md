# WATCHDOG AMBER — 2026-05-03 06:08 +08
...
- checkpoint_age_min_before_report: 32.5
- latest checkpoint/report before this run: WATCHDOG_AMBER_2026-05-03_0535.md
- llama-swap: UP by Windows PowerShell, HTTP 200, models=14, required Qwen family present (`Qwen3.6-27B`)
- WSL curl 127.0.0.1:11434: empty under `curl ... | head -1`; treated as WSL localhost isolation info, not model DOWN
- run_state_file_age_min: 2523.6 (INFO only; reports/checkpoints current)
...
pc         77681  7.1  3.7 18952428 608012 ?     Sl   04:08   8:35 /usr/local/bin/node /home/pc/.npm-global/lib/node_modules/openclaw/dist/index.js gateway --port 18789
```
