# Step-by-step merge_map pipeline
$ErrorActionPreference = "Stop"
$repo = "C:\code\githubstar\wechathtmldownload"
Set-Location $repo
$outDir = "$repo\tools\stage7_rewrite\reports\atlas_core_merge_map_20260607"
...
Write-Host " Atlas Core + merge_map Step Pipeline" -ForegroundColor Magenta
...
Step "1/4 Build core DB + merge_map" {
    python -u tools\stage7_rewrite\scripts\build_atlas_core_candidate.py `
        ...
        --dataset-id atlas_core_merge_map_20260607 2>&1
}
...
Step "2/4 Export serving SQLite" {
    python -u tools\stage7_rewrite\scripts\export_atlas_core_to_serving_sqlite.py `
        --core-db tools\stage7_rewrite\reports\atlas_core_merge_map_20260607\atlas_core.sqlite `
        --out tools\stage7_rewrite\reports\atlas_core_merge_map_20260607\atlas_serving.sqlite 2>&1
}

Step "3/4 Export miniapp SQLite" {
    python -u tools\stage7_rewrite\scripts\export_atlas_core_to_miniapp_sqlite.py `
        --core-db tools\stage7_rewrite\reports\atlas_core_merge_map_20260607\atlas_core.sqlite `
        --out tools\stage7_rewrite\reports\atlas_core_merge_map_20260607\atlas_miniapp.sqlite 2>&1
}

Step "4/4 Export miniapp index" {
    python -u tools\stage7_rewrite\scripts\export_atlas_core_to_miniapp_index.py `
        --miniapp-db tools\stage7_rewrite\reports\atlas_core_merge_map_20260607\atlas_miniapp.sqlite `
        --out tools\stage7_rewrite\reports\atlas_core_merge_map_20260607\atlas_index.json.gz 2>&1
}
